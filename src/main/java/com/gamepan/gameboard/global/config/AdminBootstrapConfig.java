...
public class AdminBootstrapConfig {
    private final AdminUserService adminUserService; // <- Repository 대신 Service 주입
    ...
    public ApplicationRunner bootstrapAdmin() {
        return args -> {
            ...
            if (adminUserService.existsByRole(Role.ADMIN)) {
            ...
            try {
                adminUserService.promoteToAdminByUsername(seedUsername.trim()); // <- @Transactional(서비스)
